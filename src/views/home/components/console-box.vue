...
.console-number {
  @apply w-[40px] transition-all flex justify-center absolute top-[-20px] items-center h-[40px] rounded-full;
}
.console-number p {
  @apply text-white font-[kalameh];
}
.console-main {
  @apply flex flex-col gap-y-[3px] justify-center items-center;
}
.console-timer {
